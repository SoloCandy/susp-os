...
|---|---|---|---|---|---|---|---|
| 1 | STREET | street | race | 2.20 Hz | 1.15× | SETTLE 0.55s, bias 0 | Bump ratio 52, ARB AUTO. diffBiasExit −10 (GRIP-leaning on RWD/AWD), diffBiasEntry +10 (STABLE-leaning) |
| 2 | TRACK | track | race | 2.50 Hz | 1.05× | SETTLE 0.40s, bias −5 (FRONT) | Bump ratio 58, ARB ROLL @ 1.5°. diffBiasExit +5 (ROTATE-leaning on RWD/AWD), diffBiasEntry 0 (neutral) |
...
| 5 | MOTORSPT | track | race | 3.20 Hz | 0.92× | SETTLE 0.25s, bias −10 (FRONT) | Bump ratio 64, ARB ROLL @ 0.8°. diffBiasExit +10 (ROTATE-leaning on RWD/AWD), diffBiasEntry −5 (LOOSE-leaning) |
