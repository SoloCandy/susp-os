...
| Bump ζ | 10–115% | Independent bump damping; same readout zones as Rebound ζ, plus `⚠ CROSSED` when bump exceeds rebound. Same reach as Bump Ratio — DYNAMICS yes, RESPONSE and `bDampBias` no | None — feel only |
